...
h=ylabel('SNR');
figure(4)
boxplot(snr4,'Labels',algs)
h=xlabel('method');
set(h,'Interpreter','latex','fontsize',7)
h=ylabel('SNR')
figure(5)
boxplot(snr5,'Labels',algs)
h=xlabel('method');
set(h,'Interpreter','latex','fontsize',7)
h=ylabel('SNR');
...
% axis([0 1 0 1.5])
% KK=2:2:6;
% a=[0.1800    0.9200    0.9800    0.9600    1.0000    1.0000    1.0000  1.0    1.0;
%      0      0.9800    0.6000    0.9100    0.9200    1.0000    0.8200   0.8900  1.0;
%       0    0.8200    0.1200    0.7900    0.5400    0.8600    0.4200    0.5000  0.78];
% figure(6)
%   plot(KK,a(:,1),'kd-',KK,a(:,2),'b*:',KK,a(:,3),'ro--',KK,a(:,4),'x-.',KK,a(:,5),'gs:',KK,a(:,6),'m+-',KK,a(:,7),'bp-',KK,a(:,8),'ch-.',KK,a(:,9),'rd-','LineWidth',2)
%   hold on
%   h = xlabel('the sparsity s');
%    set(h,'Interpreter','latex','fontsize',12)
% set(gca,'xtick',2:2:6)
% h = ylabel('PrE');
% set(gca,'ytick',0:0.4:1.4)
% set(h,'Interpreter','latex','fontsize',8)
...
%   
% KK=2:2:6;
%  b=[0.1303    0.3837    0.0105    0.1241    0.0431    0.1350    0.0839  0.1155   0.0462;
%     0.0657    0.2251    0.0063    0.0693    0.0205    0.0674    0.0504    0.0680   0.0186; 
%     0.0673    0.2282    0.0063    0.0708    0.0195    0.0643    0.0507    0.0700  0.0179];
% figure(7)
%  plot(KK,b(:,1),'kd-',KK,b(:,2),'b*:',KK,b(:,3),'ro--',KK,b(:,4),'x-.',KK,b(:,5),'gs:',KK,b(:,6),'m+-',KK,b(:,7),'bp-',KK,b(:,8),'ch-.',KK,b(:,9),'rd-','LineWidth',2)
%   hold on
%   h = xlabel('the sparsity s');
%   set(gca,'xtick',2:2:6)
%   set(h,'Interpreter','latex','fontsize',8)
