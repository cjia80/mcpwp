...
% support recovery probability for   l1-LS(PDASC) 
...
% %    xlswrite('C:\installSoftware\matlab_code\test.xls',[KK',avsupp,averror], 'sheet1');  %sheet1 存放100次的结果
%        xlswrite('C:\installSoftware\matlab_code\test1.xls',[KK',avsupp,averror], 'sheet1'); %sheet2 存放100次的结果s=1:2:20
 figure(1)
% subplot(1,2,1)
